...
import polsl.pl.tab.auth.model.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        if(repository.existsByLogin(request.getLogin())){
            throw new AuthException("Login is already in use");
        }
    ...
    private void revokeAllUserTokens(User user) {
        var validUserTokens = tokenRepository.findByUser_IdAndExpiredFalseOrRevokedFalse(user.getId());
